...
var Human = function(name) {
  this.name = name;
  this.age=0;
  this.birthday = function(number) {
    this.age += number;
    console.log( "Congratulations " + this.name + "your new age: " + this.age );
  }
}
...
blake.talk = function() {
  console.log ("Hello, my name is Blake and I go to: " + blake.school + "school!");
}
...
console.log ("Ari age: " + ari.age  );
console.log ("Ari school: " + ari.school  );



// Call on the `walk` method of `ari`

console.log("Call on the `walk` method of `ari`");
ari.walk();
