...
for (var i = 0; i < numArray.length; i++) {
  if (numArray[i] > 50) {
    numSum50 = numSum50 + numArray[i];
  }
}
console.log(numSum50);
...
for (var i = 0; i < numArray.length; i++) {
  if ((numArray[i] % 2) === 0) {
    numSumEven = numSumEven + numArray[i];
  }
}
...
for (i = 0; i < twoDimArray.length; i++) {
  //  console.log("i " + twoDimArray[0][i] + "i " + i);
...
for (i = 0; i < twoDimArray.length; i++) {
  //  console.log("i " + twoDimArray[0][i] + "i " + i);
  for (j = 0; j < twoDimArray[1].length; j++) {
    if (twoDimArray[i][j] < 25) {
      console.log(twoDimArray[i][j]);
    }
...
for (i = 0; i < twoDimArray.length; i++) {
  //  console.log("i " + twoDimArray[0][i] + "i " + i);
  for (j = 0; j < twoDimArray[2].length; j++) {
    if (twoDimArray[i][j] < 25) {
      console.log(twoDimArray[i][j]);
    }
...
for (i = 0; i < twoDimArray.length; i++) {
  //  console.log("i " + twoDimArray[0][i] + "i " + i);
  for (j = 0; j < twoDimArray[3].length; j++) {
    if (twoDimArray[i][j] < 25) {
      console.log(twoDimArray[i][j]);
    }
...
for (i = 0; i < twoDimArray.length; i++) {
  //  console.log("i " + twoDimArray[0][i] + "i " + i);
  for (j = 0; j < twoDimArray[4].length; j++) {
    if (twoDimArray[i][j] < 25) {
      console.log(twoDimArray[i][j]);
    }
